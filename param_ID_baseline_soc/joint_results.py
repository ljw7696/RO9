...
fig.savefig("joint_fit_overlays.png", dpi=120, bbox_inches="tight")
...
fige.savefig("joint_fit_errors.png", dpi=120, bbox_inches="tight")
...
fig.savefig("joint_wltp_overlays.png", dpi=120, bbox_inches="tight")
fige.legend(handles=ERR_HANDLES, loc="upper right", fontsize=13, ncol=2, bbox_to_anchor=(0.99, 1.0))
fige.suptitle(r"WLTP held-out voltage error $V_{data}-V_{SPMe}(\theta)$", fontsize=15, y=1.0)
fige.tight_layout(rect=[0, 0, 1, 0.96])
fige.savefig("joint_wltp_errors.png", dpi=120, bbox_inches="tight")
